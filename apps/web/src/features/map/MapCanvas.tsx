...
/**
 * Rendu cartographique MapLibre.
 *
 * Chargé à la demande par `IncidentMap` : la bibliothèque et sa feuille de
 * styles pèsent plus que tout le reste de l'application réuni, et ne servent
 * que sur trois écrans. Bascule vers la vue schématique si le fond de plan ne
 * se charge pas ; l'appelant ignore lequel des deux rendus est actif.
 */
